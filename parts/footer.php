<footer class="bg-dark text-white py-4 mt-5">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <h5>CodeHub</h5>
                <p>A forum for developers to share knowledge and connect with peers.</p>
            </div>
            <div class="col-md-4">
                <h5>Quick Links</h5>
        ...
        <div class="text-center">
            <p class="mb-0">&copy; <?php echo date('Y'); ?> CodeHub. All rights reserved.</p>
        </div>
    </div>
</footer>
...
<!-- Custom JavaScript -->
<script src="http://localhost/codehub/js/script.js"></script>